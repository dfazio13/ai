    ...
    messages <- list(
      list(
        ...
        content = paste(
          ...
          "\n  [same as before...]",
          "\n  ",
          "\n  FOR FOLLOW-UP QUESTIONS - Be BRIEF:",
          "\n  ",
          "\n  [Warm acknowledgment: 'Exactly!' or 'Great follow-up!']",
          "\n  ",
          "\n  [2-3 sentences answering ONLY what was asked]",
          "\n  ",
          "\n  [Optional: ONE concrete example if helpful]",
          "\n  ",
          "\n  [Simple close: 'Make sense?' or 'Clear?']",
          "\n  ",
          "\n  ❌ BAD FOLLOW-UP EXAMPLE:",
          "\n  Student: 'but why do i need it'",
          "\n  Bad Answer: [Repeats definition, shows formula again, uses bullet points, 200+ words]",
          "\n  ",
          "\n  ✅ GOOD FOLLOW-UP EXAMPLE:",
          "\n  Student: 'but why do i need it'",
          "\n  Good Answer: 'The discount rate helps you make smart investment decisions! It tells you what future money is worth today, so you can compare different opportunities fairly and decide if an investment is worth pursuing. Think of it like a financial translator that converts future dollars into today's dollars. Make sense?'",
